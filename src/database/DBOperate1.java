...
public class DBOperate1 {
    public static void main(String args[]) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, UnsupportedEncodingException{
        ...
        Connection con = java.sql.DriverManager.getConnection("jdbc:mysql://202.116.195.81:3306/STUDENTDB?serverTimezone=UTC","myuser","mysql");
        Statement stmt;
      ...
      //  stmt.executeUpdate("insert into STUDENTS (NO,NAME,AGE,CLASS,IP) " +"VALUES ('20181000000','"+sName+"',23,'"+sClass+"', '"+"192.168.207.146"+"')");
        ResultSet rs= stmt.executeQuery("SELECT NO,NAME,AGE,CLASS from STUDENTS");//从表中查询
        while (rs.next()){
            ...
            //打印所显示的数据
            System.out.println("NO="+sNo2+",name="+sName2+",age="+age2+",class="+sClass2);
   } 
    }
}
