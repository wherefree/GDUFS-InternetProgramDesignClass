...
//    TCPClient tcp;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String ip=jTextField2.getText();//取出IP地址数据

    String port=jTextField3.getText();//取出端口号数据
    
   
    try {
        
        udp=new UDPClient(ip,port);//udp应定义成全局变量

         jTextArea1.append("UDP连接创建成功.\r\n");
//        jTextArea1.append("服务器连接成功.\r\n");
    ...
    Thread receiver=new Thread(){//定义接收数据报文的线程
     @Override
      public void run(){
       String msg;
       while((msg = udp.receive())!=null)
